...
namespace Metabuf
{
    ...
    //////////////////////////////////////////////////////////////////////////
    static uint32_t make_crc32( uint32_t _crc, const void * _buffer, size_t _size )
    {
        const uint8_t * byte_buffer = reinterpret_cast<const uint8_t *>(_buffer);

        while( _size-- )
        {
            _crc = (_crc >> 8) ^ Crc32Table[(_crc ^ *byte_buffer++) & 0xFF];
        }

        return _crc;
    }
    //////////////////////////////////////////////////////////////////////////
    static uint32_t fini_crc32( uint32_t _crc )
    {
    ...
    {
        m_crc32 = make_crc32( m_crc32, data, size );
    }
    //////////////////////////////////////////////////////////////////////////
}