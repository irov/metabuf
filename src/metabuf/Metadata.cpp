...
namespace Metabuf
{
    ...
    //////////////////////////////////////////////////////////////////////////
    bool Metadata::parseRoot( const uint8_t * _buff, size_t _size, size_t & _read, void * _userData )
    {
        if( _size == _read )
        {
            return true;
    ...
    //////////////////////////////////////////////////////////////////////////
    bool Metadata::parse( const uint8_t * _buff, size_t _size, size_t & _read, void * _userData )
    {
        if( _size == _read )
        {
            return true;
    ...
    void Metadata::operator delete []( void * _ptr, size_t _size )
    {
        ...
        //////////////////////////////////////////////////////////////////////////
        void Metadata::_parseData( const uint8_t * _buff, size_t _size, size_t & _read )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
    ...
    //////////////////////////////////////////////////////////////////////////
    void Metadata::_parseArguments( const uint8_t * _buff, size_t _size, size_t & _read, uint32_t _id )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
    ...
    //////////////////////////////////////////////////////////////////////////
    void Metadata::_parseSingles( const uint8_t * _buff, size_t _size, size_t & _read, uint32_t _id )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
    ...
    //////////////////////////////////////////////////////////////////////////
    void Metadata::_parseIncludes( const uint8_t * _buff, size_t _size, size_t & _read, uint32_t _id )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
    ...
    //////////////////////////////////////////////////////////////////////////
    void Metadata::_parseChildren( const uint8_t * _buff, size_t _size, size_t & _read, uint32_t _id )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
    ...
    //////////////////////////////////////////////////////////////////////////
    void Metadata::_parseGenerators( const uint8_t * _buff, size_t _size, size_t & _read, uint32_t _id )
    {
        (void)_buff;
        (void)_size;
        (void)_read;
