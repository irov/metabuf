...
namespace Metabuf
{
    ...
    {        
        ...
        this->write(_ss) << "{" << std::endl;
		this->write(_ss) << "    //////////////////////////////////////////////////////////////////////////" << std::endl;
        this->write(_ss) << "    static bool readHeader2( const unsigned char * _buff, size_t _size, size_t & _read, uint32_t & _readVersion, uint32_t & _needVersion, void * _userData )" << std::endl;
        this->write(_ss) << "    {" << std::endl;
		...
		this->write(_ss) << "    bool readHeader( const unsigned char * _buff, size_t _size, size_t & _read, uint32_t & _readVersion, uint32_t & _needVersion, void * _userData )" << std::endl;
		this->write(_ss) << "    {" << std::endl;
		this->write(_ss) << "        try" << std::endl;
		this->write(_ss) << "        {" << std::endl;
		this->write(_ss) << "            bool successful = readHeader2( _buff, _size, _read, _readVersion, _needVersion, _userData );" << std::endl;
		this->write(_ss) << std::endl;
		this->write(_ss) << "            return successful;" << std::endl;
		this->write(_ss) << "        }" << std::endl;
		this->write(_ss) << "        catch( const Metabuf::ArchiveException & )" << std::endl;
		this->write(_ss) << "        {" << std::endl;
		this->write(_ss) << "        }" << std::endl;
		this->write(_ss) << std::endl;
		this->write(_ss) << "        return false;" << std::endl;
		this->write(_ss) << "    }" << std::endl;
        this->write(_ss) << "    //////////////////////////////////////////////////////////////////////////" << std::endl;
        this->write(_ss) << "    static bool readStrings2( const unsigned char * _buff, size_t _size, size_t & _read, uint32_t & _stringCount, void * _userData )" << std::endl;
        this->write(_ss) << "    {" << std::endl;
        this->write(_ss) << "        Metabuf::ArchiveReader ar(_buff, _size, _read, _userData);" << std::endl;
        this->write(_ss) << std::endl;
		...
		this->write(_ss) << "        try" << std::endl;
		this->write(_ss) << "        {" << std::endl;
		this->write(_ss) << "            bool successful = readStrings2( _buff, _size, _read, _stringCount, _userData );" << std::endl;
		this->write(_ss) << std::endl;
		this->write(_ss) << "            return successful;" << std::endl;
		this->write(_ss) << "        }" << std::endl;
		this->write(_ss) << "        catch( const Metabuf::ArchiveException & )" << std::endl;
		...
		this->write(_ss) << "    }" << std::endl;
        this->write(_ss) << "    //////////////////////////////////////////////////////////////////////////" << std::endl;
        this->write(_ss) << "    static const char * readString2( const unsigned char * _buff, size_t _size, size_t & _read, uint32_t & _stringSize, void * _userData )" << std::endl;
        this->write(_ss) << "    {" << std::endl;
        this->write(_ss) << "        Metabuf::ArchiveReader ar(_buff, _size, _read, _userData);" << std::endl;
        this->write(_ss) << std::endl;
		...
		this->write(_ss) << "        try" << std::endl;
		this->write(_ss) << "        {" << std::endl;
		this->write(_ss) << "            const char * value = readString2( _buff, _size, _read, _stringSize, _userData );" << std::endl;
		this->write(_ss) << std::endl;
		this->write(_ss) << "            return value;" << std::endl;
		this->write(_ss) << "        }" << std::endl;
		this->write(_ss) << "        catch( const Metabuf::ArchiveException & )" << std::endl;
		...
		this->write(_ss) << "        }" << std::endl;
		this->write(_ss) << std::endl;
		this->write(_ss) << "        return nullptr;" << std::endl;
		this->write(_ss) << "    }" << std::endl;
		this->write(_ss) << "    //////////////////////////////////////////////////////////////////////////" << std::endl;
